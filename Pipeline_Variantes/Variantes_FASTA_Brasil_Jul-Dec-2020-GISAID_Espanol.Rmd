...
# 5) Implementación del cálculo de frecuencias alélicas
...
echo "scale=3; ${NumberN501Y} / ${TotalFASTNumber} " | bc


##frequency= ( $NumeroTotalFASTA / $NumeroN501Y )
##echo " Frequency is N501Y = $frequency"
```
...
frequency=$("scale=3; ${NumberN501Y} / ${TotalFASTNumber} " | bc)
echo "The Frequency of N501Y is: "$frequency
```
